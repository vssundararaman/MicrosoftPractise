...
public class TextJustification {
    ...
    public static void main(String[] args) {
       ...
       int maxWidth = 16;
        ...
        System.out.println (textJustification (words,maxWidth));
    }

    static List<String> textJustification(String[] words, int maxLen) {
    ...
    static List<String> textJustification1(String[] words, int maxLen){
